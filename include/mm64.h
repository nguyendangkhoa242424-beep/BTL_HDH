...
#define PAGING64_PGTBL_ENTRIES 512

typedef struct pt_t {
    addr_t entries[PAGING64_PGTBL_ENTRIES];
} pt_t;

typedef struct pmd_t {
    pt_t *entries[PAGING64_PGTBL_ENTRIES];
} pmd_t;

typedef struct pud_t {
    pmd_t *entries[PAGING64_PGTBL_ENTRIES];
} pud_t;

typedef struct p4d_t {
    pud_t *entries[PAGING64_PGTBL_ENTRIES];
} p4d_t;

typedef struct pgd_t {
    p4d_t *entries[PAGING64_PGTBL_ENTRIES];
} pgd_t;
